...
DROP TABLE paisPartidaJugador CASCADE CONSTRAINTS;
DROP TABLE recurso CASCADE CONSTRAINTS;
DROP TABLE inventarioRecurso CASCADE CONSTRAINTS;
DROP TABLE construccion CASCADE CONSTRAINTS;
DROP TABLE trueque CASCADE CONSTRAINTS;
...
DELETE FROM inventarioRecurso;
DELETE FROM paisPartidaJugador;
DELETE FROM partida;
DELETE FROM jugador;
DELETE FROM recurso;
DELETE FROM pais;
